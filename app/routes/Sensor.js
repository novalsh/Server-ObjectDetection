...
const { getSensors, getSensor, createSensor, getSensorByToken, updateSensor, updateSensorRaspberry, deleteSensor, updateAllSensorTimes } = require('../controllers/SensorController');
